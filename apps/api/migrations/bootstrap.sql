...
-- Requires ZIFTBOOK_MIGRATE_PASSWORD and ZIFTBOOK_APP_PASSWORD in the environment. If either is unset, the
...
\getenv migrate_password ZIFTBOOK_MIGRATE_PASSWORD
\getenv app_password ZIFTBOOK_APP_PASSWORD
